...
$_SESSION['success_update_category'] = false;
$_SESSION['success_delete_category'] = false;
$_SESSION['success_delete_place'] = false;
$_SESSION['success_update_place'] = false;
$_SESSION['success_add_place'] = false;
?>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo PROJECT.'/views/template/assets/css/zabuto_calendar.css'?>">
    <link rel="stylesheet" type="text/css" href="<?php echo PROJECT.'/views/template/assets/js/gritter/css/jquery.gritter.css'?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo PROJECT.'/views/template/assets/lineicons/style.css'?>">
    ...
    <script src="<?php echo PROJECT.'/views/templateassets/js/chart-master/Chart.js'?>"></script>
  ...
  <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?php echo PROJECT . '/index.php'?>">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <a href="<?php echo PROJECT.'/views/forms/category/AddCategory.php'?>"><div class="col-md-4 col-sm-4 mb">
                      ...
                      <a href="<?php echo PROJECT.'/views/forms/category/ViewCategory.php'?>"><div class="col-md-4 col-sm-4 mb">
                              <div class="white-panel pn">
                                  <div class="white-header">
                      ...
                      <a href="<?php echo PROJECT.'/views/forms/category/UpdateCategory.php'?>"><div class="col-md-4 col-sm-4 mb">
                              <div class="white-panel pn">
                                  <div class="white-header">
                      ...
                      <a href="<?php echo PROJECT.'/views/forms/places/AddPlace.php'?>"><div class="col-md-4 col-sm-4 mb">
                              <div class="white-panel pn">
                                  <div class="white-header">
                                      <h5>ADD PLACES</h5>
                                  </div>
                      ...
                      <a href="<?php echo PROJECT.'/views/forms/places/ViewPlace.php'?>"><div class="col-md-4 col-sm-4 mb">
                              <div class="white-panel pn">
                                  <div class="white-header">
                                      <h5>VIEW PLACES</h5>
                                  </div>
                      ...
                      <a href="<?php echo PROJECT.'/views/forms/places/UpdatePlace.php'?>"><div class="col-md-4 col-sm-4 mb">
                              <div class="white-panel pn">
                                  <div class="white-header">
                                      <h5>UPDATE PLACES</h5>
                                  </div>
    ...
    <script src="<?php echo PROJECT.'/views/template/assets/js/jquery-1.8.3.min.js'?>"></script>
    ...
    <script src="<?php echo PROJECT.'/views/template/assets/js/jquery.sparkline.js'?>"></script>


    <!--common script for all pages-->
    <script src="<?php echo PROJECT.'/views/template/assets/js/common-scripts.js'?>"></script>

    <script type="text/javascript" src="<?php echo PROJECT.'/views/template/assets/js/gritter/js/jquery.gritter.js'?>"></script>
    <script type="text/javascript" src="<?php echo PROJECT.'/views/template/assets/js/gritter-conf.js'?>"></script>

    <!--script for this page-->
    <script src="<?php echo PROJECT.'/views/template/assets/js/sparkline-chart.js'?>"></script>
	<script src="<?php echo PROJECT.'/views/template/assets/js/zabuto_calendar.js'?>"></script>
...
<!-- Mirrored from www.blacktie.co/demo/dashgum/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Nov 2017 20:30:16 GMT -->
</html>
