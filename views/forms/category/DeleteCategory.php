...
<section id="container" >
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <header class="header black-bg">
        ...
        <!--logo start-->
        <a href="index-2.html" class="logo"><b>DASHGUM FREE</b></a>
        <!--logo end-->
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <?php
            if($_SESSION['success_update_category'] == true){
            ...
            if($_SESSION['success_delete_category'] == true){
            echo "<div class=\"alert alert-success alert-dismissable\">
            <a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a>
            ...
            ?>
            <h3><i class="fa fa-angle-right"></i> Delete Category</h3>

            <!-- INLINE FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <h4 class="mb"><i class="fa fa-angle-right"></i> Are you sure you want to delete this category?</h4>
                        <form class="form-inline" role="form" method="post" action="<?php echo PROJECT.'/controllers/DeleteCategoryController.php'?>">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputEmail2">ID</label>
                                <input type="text" name="id" class="form-control" id="exampleInputEmail2" value="<?php echo $id; ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputEmail2">Category</label>
                                <input type="text" name="category" class="form-control" id="exampleInputEmail2" value="<?php echo $category; ?>" readonly>
                            </div>

                            <button name="deleteCategory" class="btn btn-theme">Delete</button>
                        </form>
                    </div><!-- /form-panel -->
                </div><!-- /col-lg-12 -->
            </div><!-- /row -->
