...
if(!isset($_SESSION['success_update_category'])){
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a  href="<?php echo PROJECT.'/views/forms/places/DeletePlace.php'?>">Delete Places</a></li>
                    </ul>
                </li>
...
<th colspan="2">ACTIONS</th>
            ...
            for($i=0; $i<$count;$i++){
                ...
                echo '<tr>
    		<td>'.$serial_number.'</td>
    		<td>'.$all_arrays[$i]['category'].'</td>
    		<td>'."<a href='UpdateCategory.php?id={$pass_id}'><button type=\"addCategory\" class=\"btn btn-theme\">Update</button>".'</td>
    		<td>'."<a href='DeleteCategory.php?id={$pass_id}'><button type=\"addCategory\" class=\"btn btn-theme\">Delete</button></a>".'</td>
    	</tr>';
