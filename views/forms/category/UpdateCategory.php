            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        ...
                        <form class="form-inline" role="form" method="post" action="<?php echo PROJECT.'/controllers/UpdateCategoryController.php'?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="category" class="form-control" id="exampleInputEmail2" value="<?php echo $category; ?>">
                            </div>

                            <button name="updateCategory" class="btn btn-theme">Done</button>
                        </form>
                    </div><!-- /form-panel -->
                </div><!-- /col-lg-12 -->
            </div><!-- /row -->
