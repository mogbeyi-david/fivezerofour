...
$id = $_GET['id'];
$query = "SELECT name_of_place FROM places WHERE id = '$id'";
            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        ...
                        <form class="form-inline" role="form" method="post" action="<?php echo PROJECT.'/controllers/DeletePlaceController.php'?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="category" class="form-control" id="exampleInputEmail2" value="<?php echo $place; ?>">
                            </div>

                            <button name="deletePlace" class="btn btn-theme">Delete</button>
                        </form>
                    </div><!-- /form-panel -->
                </div><!-- /col-lg-12 -->
            </div><!-- /row -->
