    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Add Places</h3>

            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <h4 class="mb"><i class="fa fa-angle-right"></i> Enter Information on the place</h4>
                        <form class="form-horizontal style-form" method="post" action="<?php echo PROJECT.'/controllers/UpdatePlaceController.php'?>">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">Name of the Place</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name_of_place" value="<?php echo $row['name_of_place'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">Activities</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="activities" value="<?php echo $row['activities'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">Description From Gate</label>
                                <div class="col-sm-10">
                                    <textarea name="description_gate" class="form-control" rows="3"><?php echo $row['description_gate']?></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">Description From Hostel</label>
                                <div class="col-sm-10">
                                    <textarea name="description_hostel" class="form-control" rows="3"><?php echo $row['description_hostel']?></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">Description from SUB</label>
                                <div class="col-sm-10">
                                    <textarea name="description_sub" class="form-control" rows="3"><?php echo $row['description_sub']?></textarea>
                                </div>
                            </div>


                            <button name="updatePlace" class="btn btn-theme">Done</button>
                        </form>
                    </div>
                </div><!-- col-lg-12-->
            </div><!-- /row -->
    ...
    <footer class="site-footer">
        <div class="text-center">
            2017 - MogbeyiDavid
            <a href="AddPlace.php#" class="go-top">
