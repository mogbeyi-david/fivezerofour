            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        ...
                        <form class="form-horizontal style-form" method="post" action="<?php echo PROJECT.'/controllers/AddPlaceController.php'?>">
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">Name of the Place</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name_of_place">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description_gate" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description_hostel" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description_sub" class="form-control" rows="3"></textarea>
                                </div>
                            </div>


                            <button name="addPlace" class="btn btn-theme">Done</button>
                        </form>
                    </div>
                </div><!-- col-lg-12-->
            </div><!-- /row -->
